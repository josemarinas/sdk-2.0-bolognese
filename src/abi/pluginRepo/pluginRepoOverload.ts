// Viem does not support overload ABIs so we need
// to manually define the ABI for the pluginRepo
// contract with the overloaded method that we
// want to use.
//
// See: https://github.com/wevm/viem/discussions/1799
export const PLUGIN_REPO_OVERLOAD_ABI = [
  { inputs: [], stateMutability: "nonpayable", type: "constructor" },
  { inputs: [], name: "AnyAddressDisallowedForWhoAndWhere", type: "error" },
  { inputs: [], name: "ConditionNotPresentForAnyAddress", type: "error" },
  { inputs: [], name: "EmptyReleaseMetadata", type: "error" },
  { inputs: [], name: "InvalidPluginSetupInterface", type: "error" },
  {
    inputs: [
      { internalType: "uint8", name: "latestRelease", type: "uint8" },
      { internalType: "uint8", name: "newRelease", type: "uint8" },
    ],
  ...
  { inputs: [], name: "ReleaseDoesNotExist", type: "error" },
  ...
  {
    inputs: [{ internalType: "bytes32", name: "versionHash", type: "bytes32" }],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "uint8", name: "release", type: "uint8" },
      {
        indexed: false,
        internalType: "bytes",
  ...
  },
  {
    ...
    inputs: [
      { indexed: false, internalType: "uint8", name: "release", type: "uint8" },
      { indexed: false, internalType: "uint16", name: "build", type: "uint16" },
      {
        indexed: true,
        internalType: "address",
        name: "pluginSetup",
  ...
  {
    inputs: [{ internalType: "uint8", name: "_release", type: "uint8" }],
    name: "buildCount",
  ...
  {
    inputs: [
      { internalType: "uint8", name: "_release", type: "uint8" },
      { internalType: "address", name: "_pluginSetup", type: "address" },
      { internalType: "bytes", name: "_buildMetadata", type: "bytes" },
      { internalType: "bytes", name: "_releaseMetadata", type: "bytes" },
    ],
    name: "createVersion",
    outputs: [],
    stateMutability: "nonpayable",
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "address", name: "pluginSetup", type: "address" },
          { internalType: "bytes", name: "buildMetadata", type: "bytes" },
        ],
  ...
  {
    inputs: [{ internalType: "bytes32", name: "_tagHash", type: "bytes32" }],
    name: "getVersion",
    outputs: [
      {
        components: [
